...
modules["programs.MachineController"] = function() local aa=require("libraries.basalt")
local ba=require("elements.TabView")local ca=true;aa.LOGGER.setEnabled(ca)
aa.LOGGER.setLogToFile(true)local da=aa.getMainFrame()
aa.LOGGER.debug("Starting MachineController...")
local _b=ba:new(da:addFrame(),1,1,da:getWidth(),da:getHeight())_b:createTab("Tab 1")_b:createTab("Tab 2")
_b:createTab("Tab 3")_b:createTab("Tab 4")_b:createTab("Tab 5")
_b:createTab("Tab 6")_b:createTab("Tab 7")_b:createTab("Tab 8")
_b:createTab("Tab 9")_b:init()aa.run() end
...
return modules["programs.MachineController"]()